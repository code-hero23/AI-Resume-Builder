...
const Features = () => {
  ...
  return (
    <div id='features' className='flex flex-col items-center my-10 scroll-mt-12'>
        ...
        <Title title='Build Your Resume' description="Instantly transform your career story. Our AI-powered resume builder doesn't just format—it crafts a document designed to beat the bots and impress the humans. Stop guessing, start getting interviews"/>
